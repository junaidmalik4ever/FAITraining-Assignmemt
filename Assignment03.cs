...
namespace Assignments_junaidmalik
{
    class Assignment03
    {
        ...
        {
            double fValue = UserInterfaceConsole.GetDouble("Enter the Number");
            Console.WriteLine("The SquareRoot of " + fValue + " : " + Math.Sqrt(fValue));
        }

        private static void squareOperation()
        {
            double fValue = UserInterfaceConsole.GetDouble("Enter the Number");
            Console.WriteLine("The Square value of " + fValue + " : " + (fValue * fValue));
        }

        private static void divideOperation()
        {
            double fValue = UserInterfaceConsole.GetDouble("Enter the First Number");
            double sValue = UserInterfaceConsole.GetDouble("Enter the Second Number");
